...
- Follow the `pokemax-commit-format` skill (`.claude/skills/pokemax-commit-format/SKILL.md`) for commit subject/body/backtick rules, including the zero-AI-attribution rule.
